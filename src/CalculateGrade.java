...
//class calculate grade is created
...
// if else condition to check with which grade person has passed the exam
        if (percentage>=80) {
            ...
            System.out.println(name+ " has passed with Grade A+");
        } else if (percentage>=60) {

            System.out.println(name+ " has passed with Grade A");
        } else if (percentage>=50) {

            System.out.println(name+ " has passed with Grade B");
        } else if(percentage>=35){
            System.out.println(name+ " has passed with Pass-class");
        } else {
